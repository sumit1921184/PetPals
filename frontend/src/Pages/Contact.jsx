...
function Contact() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            country. Alternatively, complete the enquiry form below and we will
            make sure it gets to your nearest Petpals team:
          </Text>
        </VStack>
      </Box>
      ...
      <Box as="footer" py={20} fontSize={12}>
        <Container maxW="container.xl" w="80%">
          ...
          >
            ...
            <Box fontSize="16px" marginLeft="15%" w="100%">
              <Text textAlign={{ base: "center", sm: "left" }} mb={4}>
              ...
              <Text textAlign={{ base: "center", sm: "left" }} mb={4}>
                ©Copyright 2014 Petpals (UK) Limited. Registered in England No.
                04198335
              </Text>
              <Flex justify="center">
